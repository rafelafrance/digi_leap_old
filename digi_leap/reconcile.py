...
def reconcile(unreconciled_csv, image_dir, reconciled_jsonl):
    """Reconcile data from a Label Babel expedition."""
    classifications = get_classifications(unreconciled_csv)
    subjects = group_by_subject(classifications)
    subjects = subject_images(image_dir, subjects)
